  ...
  return (
    <div className="bg-[url(/cool4.png)] bg-cover bg-center min-h-screen">
      ...
      <div className="flex justify-center flex-col items-center mt-10 ">
        ...
        <div className="border  rounded-md shadow-lg backdrop-blur-md">
          ...
          <button
            ...
            className="text-xl text-center ml-6 mt-10 px-6 py-2 border bg-black text-white rounded-md mb-4 "
          >
            Update Profile
          </button>
        </div>
