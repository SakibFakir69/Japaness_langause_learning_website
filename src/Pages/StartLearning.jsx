    ...
    <div className="mt-10 bg-[url(/cool4.png)] rounded-md ">
      ...
      <div className="text-center">
        <h1 className="text-2xl font-semibold text-white ">
          Start you Journy Now
        </h1>
        <p className="text-gray-300">
          Expand your vocabulary and master new skills!
        </p>
      </div>
      ...
      <div className="grid md:grid-cols-3 gap-4 sm:grid-cols-2 justify-around px-4 mt-10">
        ...
        <div
          className="border p-4 text-xl font-semibold cursor-pointer rounded-md bg-black text-white"
          onClick={() => toast.error("This lesson coming soon")}
        >
          Lesson - 11
        </div>
        <div
      ...
      <div className="mt-10 flex flex-col text-center justify-center items-center space-y-4">
        ...
        <iframe  className="rounded-md w-full h-[400px] p-10 shadow-md" src="https://www.youtube.com/embed/7IUanmAUVx8?si=OwOciPzkQqhPgOcz" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>

          <iframe
           className="rounded-md w-full h-[400px] p-10 shadow-md"
            
            src="https://www.youtube.com/embed/-1AAnvJ27ig?si=2r5I_gZAh9JhF52j"
      ...
      <div className="text-center  mt-10 ">
        <button
          onClick={() => gottoTouto("/tutorials")}
          className="text-xl font-semibold px-6 py-2 border rounded-md bg-purple-500 mb-4"
        >
          View More
        </button>
      </div>
